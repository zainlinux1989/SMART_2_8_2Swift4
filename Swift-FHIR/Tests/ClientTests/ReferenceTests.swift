...
class ReferenceTests: XCTestCase {
	...
	func testContainedReference() {
		if let path = Bundle(for: Swift.type(of: self)).path(forResource: "ReferenceContained1", ofType: "json", inDirectory: "TestResources") {
		...
		if let path = Bundle(for: Swift.type(of: self)).path(forResource: "ReferenceContained2", ofType: "json", inDirectory: "TestResources") {
			let order1 = try! MedicationOrder.instantiate(fromPath: path)
	...
	func testBundledReference() {
		if let path = Bundle(for: Swift.type(of: self)).path(forResource: "ReferenceBundled", ofType: "json", inDirectory: "TestResources") {
	...
	func testRelativeReference() {
		if let path = Bundle(for: Swift.type(of: self)).path(forResource: "ReferenceRelative", ofType: "json", inDirectory: "TestResources") {
			let order1 = try! MedicationOrder.instantiate(fromPath: path)
	...
	func testAbsoluteReference() {
		if let path = Bundle(for: Swift.type(of: self)).path(forResource: "ReferenceAbsolute", ofType: "json", inDirectory: "TestResources") {
			let order1 = try! MedicationOrder.instantiate(fromPath: path)
